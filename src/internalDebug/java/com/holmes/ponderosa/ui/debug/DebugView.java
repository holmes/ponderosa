package com.holmes.ponderosa.ui.debug;
...
import com.holmes.ponderosa.data.api.MockHomeSeerService;
import com.jakewharton.processphoenix.ProcessPhoenix;
import com.jakewharton.rxbinding.widget.RxAdapterView;
import com.holmes.ponderosa.BuildConfig;
import com.holmes.ponderosa.R;
import com.holmes.ponderosa.data.AnimationSpeed;
import com.holmes.ponderosa.data.ApiEndpoint;
import com.holmes.ponderosa.data.ApiEndpoints;
import com.holmes.ponderosa.data.CaptureIntents;
...
import com.holmes.ponderosa.data.PicassoDebugging;
import com.holmes.ponderosa.data.PixelGridEnabled;
import com.holmes.ponderosa.data.PixelRatioEnabled;
import com.holmes.ponderosa.data.ScalpelEnabled;
import com.holmes.ponderosa.data.ScalpelWireframeEnabled;
...
import com.holmes.ponderosa.ui.logs.LogsDialog;
import com.holmes.ponderosa.ui.misc.EnumAdapter;
import com.holmes.ponderosa.util.Keyboards;
...
public final class DebugView extends FrameLayout {
  ...
  @Inject MockHomeSeerService mockHomeSeerService;
  ...
  //  spinner.setSelection(mockHomeSeerService.getResponse(responseClass).ordinal());
  //
  //  RxAdapterView.itemSelections(spinner)
  //      .map(adapter::getItem)
  //      .filter(item -> item != mockHomeSeerService.getResponse(responseClass))
  //      .subscribe(selected -> {
  //        Timber.d("Setting %s to %s", responseClass.getSimpleName(), selected);
  //        mockHomeSeerService.setResponse(responseClass, selected);
  //      });
  //}
  //
