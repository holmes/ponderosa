...
public final class PonderosaTestRunner extends AndroidJUnitRunner {
  private PowerManager.WakeLock wakeLock;

  @SuppressLint("MissingPermission")
  @Override public void onStart() {
    // Inform the app we are an instrumentation test before the object graph is initialized.
    DebugPonderosaModule.instrumentationTest = true;

    Context app = getTargetContext().getApplicationContext();

    String name = PonderosaTestRunner.class.getSimpleName();
